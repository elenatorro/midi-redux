...
export const MIDIEventsReader = {
  ...
  getEvent: {
    ...
    0x20: function midiChannelPrefix(event, stream) {
      MIDIErrors.checkStreamLength(MIDIEvents.Meta.Type.MidiChannelPrefix.NAME, MIDIEvents.Meta.Type.MidiChannelPrefix.LENGTH, MIDIUtils.getStreamLength(stream));
    ...
    0x2f: function endOfTrack(event, stream) {
      MIDIErrors.checkStreamLength(MIDIEvents.Meta.Type.EndOfTrack.NAME, MIDIEvents.Meta.Type.EndOfTrack.LENGTH, MIDIUtils.getStreamLength(stream));
      event.subtype = MIDIEvents.Meta.Type.EndOfTrack.NAME;
      return event;
    },

    0x51: function setTempo(event, stream) {
      MIDIErrors.checkStreamLength(MIDIEvents.Meta.Type.SetTempo.NAME, MIDIEvents.Meta.Type.SetTempo.LENGTH, MIDIUtils.getStreamLength(stream));
    ...
    0x54: function smpteOffset(event, stream) {
      ...
      MIDIErrors.checkStreamLength(MIDIEvents.Meta.Type.SMPTEOffset.NAME, MIDIEvents.Meta.Type.SMPTEOffset.LENGTH, MIDIUtils.getStreamLength(stream));
    ...
    0x58: function timeSignature(event, stream) {
      ...
      MIDIErrors.checkStreamLength(MIDIEvents.Meta.Type.TimeSignature.NAME, MIDIEvents.Meta.Type.TimeSignature.LENGTH, MIDIUtils.getStreamLength(stream));
    ...
    0x59: function keySignature(event, stream) {
      ...
      MIDIErrors.checkStreamLength(MIDIEvents.Meta.Type.KeySignature.NAME, MIDIEvents.Meta.Type.KeySignature.LENGTH, MIDIUtils.getStreamLength(stream));
